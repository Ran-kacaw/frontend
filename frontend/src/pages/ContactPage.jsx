        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="bg-white rounded-2xl p-6 shadow-sm">
            ...
            <button
              ...
              className="w-full bg-teal text-white py-2.5 rounded-lg font-medium text-sm hover:bg-teal-dark transition disabled:opacity-60 flex items-center justify-center gap-2"
            >
              <Send size={16} />
